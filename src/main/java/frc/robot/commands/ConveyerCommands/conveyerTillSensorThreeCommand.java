...
public class conveyerTillSensorThreeCommand extends Command {
  /** Creates a new conveyTillSensorThree. */

  private ConveyerSubsystem CONVEYER_SUBSYSTEM; 
  private double initTime; 

  public conveyerTillSensorThreeCommand(ConveyerSubsystem conveyer) {
  ...
  public boolean isFinished() {
    if(CONVEYER_SUBSYSTEM.getConveyerSwitchThreeValue() == true){
      return true; 
    }
