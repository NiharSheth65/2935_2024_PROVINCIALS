...
public class conveyerSetSpeedCommand extends Command {
  /** Creates a new conveyerSetSpeedCommand. */
  private  ConveyerSubsystem CONVEYER_SUBSYSTEM; 
  private double conveyerSpeed;

  public conveyerSetSpeedCommand(ConveyerSubsystem conveyer, double speed) {
