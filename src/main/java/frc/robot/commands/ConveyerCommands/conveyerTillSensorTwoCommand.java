...
public class conveyerTillSensorTwoCommand extends Command {
  /** Creates a new conveyTillSensorTwo. */

  private ConveyerSubsystem CONVEYER_SUBSYSTEM; 
  private double initTime; 

  public conveyerTillSensorTwoCommand(ConveyerSubsystem conveyer) {
  ...
  public boolean isFinished() {
    if(CONVEYER_SUBSYSTEM.getConveyerSwitchTwoValue() == true){
      return true; 
    }
