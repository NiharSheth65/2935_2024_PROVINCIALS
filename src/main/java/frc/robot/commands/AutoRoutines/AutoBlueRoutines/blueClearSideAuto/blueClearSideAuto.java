...
package frc.robot.commands.AutoRoutines.AutoBlueRoutines.blueClearSideAuto;
...
public class blueClearSideAuto extends SequentialCommandGroup {
  /** Creates a new blueClearSideAuto. */
  public blueClearSideAuto(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon, VisionSubsystem vision, IntakeSubsystem intake) {
