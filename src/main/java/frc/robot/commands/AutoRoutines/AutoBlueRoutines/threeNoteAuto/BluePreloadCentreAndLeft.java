...
public class BluePreloadCentreAndLeft extends SequentialCommandGroup {
  /** Creates a new BluePreloadCentreAndLeft. */
  public BluePreloadCentreAndLeft(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon, VisionSubsystem vision, IntakeSubsystem intake) {
