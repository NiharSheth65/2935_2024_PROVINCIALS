...
package frc.robot.commands.AutoRoutines.AutoBlueRoutines.blueAmpSideAuto;
...
public class blueAmpThreePiece extends SequentialCommandGroup {
  /** Creates a new blueAmpThreePiece. */
  public blueAmpThreePiece(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon, VisionSubsystem vision, IntakeSubsystem intake) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new note1Block(drive, shooter, conveyer, led, photon, photonVisionConstants.speakerMiddleRedID), 
      new DriveForwardSetDistance(drive, 18, DriveConstants.autoSpeed), 
      ...
      new ParallelDeadlineGroup(
        new autoHuntSpecificTag(drive, photon, photonVisionConstants.speakerMiddleBlueID, 0, photonVisionConstants.speakerMiddleApproachPitch), 
      ...
      new DriveForwardSetDistance(drive, 192, DriveConstants.autoSpeed), 

      new DriveTurnGyroCommand(drive, 20, false), 
      ...
      new ParallelDeadlineGroup(
        new DriveTurnGyroCommand(drive, -VisionConstants.adjustEndGyroAngle, false),
        new autoRevUpCommand(shooter, ShooterConstants.speakerTopMotorSpeed, ShooterConstants.speakerBottomMotorSpeed) 
      ), 
