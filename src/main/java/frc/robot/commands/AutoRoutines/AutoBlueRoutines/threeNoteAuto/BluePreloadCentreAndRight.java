...
package frc.robot.commands.AutoRoutines.AutoBlueRoutines.threeNoteAuto;
...
public class BluePreloadCentreAndRight extends SequentialCommandGroup {
  /** Creates a new BluePreloadCentreAndRight. */
  public BluePreloadCentreAndRight(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon, VisionSubsystem vision, IntakeSubsystem intake) {
