...
public class BluePreloadCentreRightAndLeft extends SequentialCommandGroup {
  /** Creates a new BluePreloadCentreRightAndLeft. */
  public BluePreloadCentreRightAndLeft(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon, VisionSubsystem vision, IntakeSubsystem intake) {
