...
package frc.robot.commands.AutoRoutines.AutoBlueRoutines.fourNoteAuto;
...
public class BluePreloadCentreLeftAndRight extends SequentialCommandGroup {
  /** Creates a new BluePreloadCentreLeftAndRight. */
  public BluePreloadCentreLeftAndRight(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon, VisionSubsystem vision, IntakeSubsystem intake) {
