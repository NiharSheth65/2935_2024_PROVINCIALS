...
public class RedShootPreloadAndExitCommunity extends SequentialCommandGroup {
  /** Creates a new RedShootPreloadAndExitCommunity. */
  public RedShootPreloadAndExitCommunity(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon) {
