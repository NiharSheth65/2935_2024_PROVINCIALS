...
public class RedPreloadCentreRightAndLeft extends SequentialCommandGroup {
  /** Creates a new RedPreloadCentreRightAndLeft. */
  public RedPreloadCentreRightAndLeft(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon, VisionSubsystem vision, IntakeSubsystem intake) {
