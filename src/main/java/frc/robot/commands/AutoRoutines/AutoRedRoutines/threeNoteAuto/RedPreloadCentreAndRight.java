...
public class RedPreloadCentreAndRight extends SequentialCommandGroup {
  /** Creates a new RedPreloadCentreAndRight. */
  public RedPreloadCentreAndRight(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon, VisionSubsystem vision, IntakeSubsystem intake) {
