...
package frc.robot.commands.AutoRoutines.AutoRedRoutines.fourNoteAuto;
...
public class RedPreloadCentreLeftAndRight extends SequentialCommandGroup {
  /** Creates a new RedPreloadCentreLeftAndRight. */
  public RedPreloadCentreLeftAndRight(DriveSubsystem drive, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, PhotonSubsystem photon, VisionSubsystem vision, IntakeSubsystem intake) {
    ...
    addCommands(
      ...
      new note3Block(drive, shooter, conveyer, led, photon, vision, intake, photonVisionConstants.speakerMiddleRedID)
    );
  }
}
