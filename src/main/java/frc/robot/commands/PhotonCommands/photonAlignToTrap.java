...
public class photonAlignToTrap extends Command {
  ...
  public photonAlignToTrap(PhotonSubsystem photon, DriveSubsystem drive, double targetAngle, boolean endCommand) {
